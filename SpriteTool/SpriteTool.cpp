...
// SpriteTool.cpp: 애플리케이션에 대한 클래스 동작을 정의합니다.
//
...
CSpriteToolApp::CSpriteToolApp() noexcept
{
	...
	SetAppID(_T("SpriteTool.AppID.NoVersion"));
...
int CSpriteToolApp::ExitInstance()
{
...
// CSpriteToolApp 사용자 지정 로드/저장 방법
