...
void EndingSceneTwo::BuildScene()
{
	Scene::BuildScene();
	...
	narrativeJson.DeserializeFromFile("Resources\\Json\\Ending2NarrativeTable.json");
	...
	SoundManager::GetInstance()->Play(500009);
}
